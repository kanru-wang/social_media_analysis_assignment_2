# -*- coding: utf-8 -*-
"""
Created on Wed Apr 25 11:06:36 2018

@author: Kevin
"""

# SOURCED FROM HERE: https://trendct.org/2015/04/03/using-python-and-r-to-pull-and-analyze-meetup-com-api-data/
...
cities =[("Bridgeport","CT"),("New Haven","CT"),("Hartford","CT"),
         ("Stamford","CT"),("Waterbury","CT")]
...
for (city, state) in cities:
    ...
    while (results_we_got == per_page):
        ...
        response=get_results({"sign":"true","country":"us", 
                              "city":city, "state":state, "radius": 10,
                              "key":api_key, "page":per_page, 
                              "offset":offset })
        time.sleep(1)
        offset += 1
